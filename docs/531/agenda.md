...
And here are some [Louisiana legends](legends.md) to consider. (For a text analytical perspective, the corpus is also on [Voyant-Tools][])
...
<!--
There are more links than these: a search for _computational model of narrative_ should turn up the annual workshop that meets under that name.
-->
